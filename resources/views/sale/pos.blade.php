                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group pos">
                                            ...
                                            @foreach($lims_customer_list as $customer)
                                                ...
                                                <option value="{{$customer->id}}">{{$customer->tax_no . ' (' . $customer->name . ')'}}</option>
                                            @endforeach
                                            </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="plazo" placeholder="Número de días" value="0"/>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="search-box form-group">
                                        <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="Escanear/Buscar producto por nombre/código" class="form-control" autofocus />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <button style="background: #0066cc" type="button" class="btn btn-primary btn-block payment-btn" data-toggle="modal" data-target="#add-payment" id="credit-card-btn"><i class="fa fa-credit-card"></i> PAGAR</button>
                                </div>
                              
                                <div class="col-lg-6">
                                    <button style="background-color: #cc0000;" type="button" class="btn btn-danger btn-block" id="cancel-btn" onclick="return confirmCancel()"><i class="ion-android-cancel"></i> Cancelar</button>
                                </div>
                            </div>
                            ...
                            <table id="product-table" class="table product-list">
                                ...
                                @for ($i=0; $i < ceil($product_number/5); $i++)
                                    <tr>
                                        ...
                                        <td class="product-img sound-btn" title="{{$lims_product_list[1+$i*5]->name}}" data-product ="{{$lims_product_list[1+$i*5]->code . ' (' . $lims_product_list[1+$i*5]->name . ')'}}"><img  src="{{$lims_product_list[1+$i*5]->base_image}}" width="100%" />
                                        ...
                                        <td class="product-img sound-btn" title="{{$lims_product_list[2+$i*5]->name}}" data-product ="{{$lims_product_list[2+$i*5]->code . ' (' . $lims_product_list[2+$i*5]->name . ')'}}"><img  src="{{$lims_product_list[2+$i*5]->base_image}}" width="100%" />
                                        ...
                                        <td class="product-img sound-btn" title="{{$lims_product_list[3+$i*5]->name}}" data-product ="{{$lims_product_list[3+$i*5]->code . ' (' . $lims_product_list[3+$i*5]->name . ')'}}"><img  src="{{$lims_product_list[3+$i*5]->base_image}}" width="100%" />
                                        ...
                                        <td class="product-img sound-btn" title="{{$lims_product_list[4+$i*5]->name}}" data-product ="{{$lims_product_list[4+$i*5]->code . ' (' . $lims_product_list[4+$i*5]->name . ')'}}"><img  src="{{$lims_product_list[4+$i*5]->base_image}}" width="100%" />
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{ route('sales.edit', $sale) }}" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;
                                                        @endif
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        @if(session()->has('error_formato_doc'))
        swal({
            title: "Error!",
            text: "Seleccione el tipo de identificación correcto!",
            icon: "warning",
            button: true,
            dangerMode: true,
          })
        ...
        @endif
        @if(session()->has('error_cantidad_consumidor'))
    swal({
        title: "Error!",
        text: "La factura supera los 200 USD de importe total por cuanto no puede ser emitida a nombre del CONSUMIDOR FINAL!",
        icon: "warning",
        button: true,
        dangerMode: true,
      })
        ...
        if (Object.keys(data).length != 0) {
            $.each(data['name'], function(index) {
                ...
                if(index % 5 == 0 && index != 0){
                    tableData += '</tr><tr><td class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><img  src="'+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p></td>';
                }
                else
                    tableData += '<td class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><img  src="'+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p></td>';
            });
            ...
            tableData += '<td class="text-center">No hay datos disponibles.</td></tr></tbody></table>'
            $(".table-container").html(tableData);
        }
    });
});
...
$("#gift-card-btn").on("click",function(){
    $('select[name="forma_pago"]').val(2);
    giftCard();
});

$("#credit-card-btn").on("click",function(){
    $('select[name="forma_pago"]').val("01");
    //creditCard();
});

$("#cheque-btn").on("click",function(){
    $('select[name="forma_pago"]').val(4);
    cheque();
});

$("#cash-btn").on("click",function(){
    $('select[name="forma_pago"]').val(1);
    hide();
});

$("#paypal-btn").on("click",function(){
    $('select[name="forma_pago"]').val(5);
    hide();
});

$("#deposit-btn").on("click",function(){
    $('select[name="forma_pago"]').val(6);
    hide();
    deposits();
});

$('select[name="forma_pago"]').on("change", function() {
    //alert("hola");
    var id = $(this).val();
...
$('input[name="paid_amount"]').on("input", function() {
    ...
    var id = $('select[name="forma_pago"]').val();
    if(id == 2){
