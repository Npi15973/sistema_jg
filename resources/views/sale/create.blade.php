                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione pto emisión...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="forma_pago" id="forma_pago" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione forma de pago...">
                                                ...
                                                @foreach($formas_pago as $pagos)
                                                <option value="{{$pagos->codigo}}">{{$pagos->descripcion}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="plazo" value="0" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
